...
NMilitary = {
	...
	EXPERIENCE_LOSS_FACTOR = 0.8,                 -- percentage of experienced solders who die when manpower is removed
	...
	ORG_LOSS_FACTOR_ON_CONQUER = 1.0,              -- percentage of (max) org loss on takign enemy province
	...
	RETREAT_SPEED_FACTOR = 1.0,                    -- speed bonus when retreating
...
NNavy = {
	...
	EXPERIENCE_LOSS_FACTOR = 0.80,                 					-- percentage of experienced solders who die when manpower is removed
